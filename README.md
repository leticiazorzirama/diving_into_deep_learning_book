...
The repo is organized by chapter, with folders for each chapter, mirroring the book's layout:

```
├── ch01_introduction/
├── ch02_preliminaries/
│   ├── 2_1_data_manipulation
│   ├── 2_2_data_preprocessing
│   ├── 2_3_linear_algebra
│   └── ...
├── ch03_linear_neural_networks/
│   ├── 3_1_linear_regression/
│   ├── 3_2_linear_regression_scratch/
│   └── ...
├── ...
```
